class CreateDeputyHistoriesFix < ActiveRecord::Migration[8.0]
  def change
    create_table :deputy_histories do |t|
      # Basic information
      t.integer :deputy_external_id, null: false # ID of the parliamentarian (e.g., 204379)
    ...
    add_index :deputy_histories, :deputy_external_id
